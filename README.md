...
## News and Updates 🚀🚀🚀
- `July 01, 2024`: All-Seeing Project v2 is accepted by ECCV 2024! Note that the [model](https://huggingface.co/OpenGVLab/ASMv2) and [data](https://huggingface.co/datasets/OpenGVLab/AS-V2) have already been released in huggingface. Try our model demo [here](https://openxlab.org.cn/apps/detail/wangweiyun/AllSeeingModel).
